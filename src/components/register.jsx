...
export default function Register() {
  ...
  const handleApiCall=async()=>{
    ...
    try{
      ...
      console.log(dto)
    const {data}=await  axios.post(`http://68.183.135.125:3100/api/auth/signup`, dto);
    if(data){
      ...
      <CardContent>
        ...
        <form className={classes.form} noValidate autoComplete="off">
          ...
          <Button
            ...
            variant="contained"
            color="primary"
            onClick={(e)=>{handleApiCall();handleSubmit(e)}}
          >
            <NavLink to ="/" className={classes.registerLink}>
               Register
            </NavLink>
          </Button>
        </form>
